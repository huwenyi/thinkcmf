...
CREATE TABLE IF NOT EXISTS `cmf_otherset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cat_type` varchar(100) DEFAULT NULL COMMENT '类型',
  `cate_type_desc` varchar(255) DEFAULT NULL COMMENT '类型说明',
  `type_value` varchar(50) DEFAULT NULL COMMENT '类型的值',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='其他说明' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `cmf_otherset`
--

INSERT INTO `cmf_otherset` (`id`, `cat_type`, `cate_type_desc`, `type_value`) VALUES
(1, 'home_slide', '首页幻灯片（轮播图）分类标识', '');
...
(1, 'Crplatform', '创瑞短信', '创瑞短信', 0, 1, '{"account_name":"15067805376","password":"C70D3FEB70094E4E6BB050847BCF"}', 'send_cr_code', 1, 'win', '1.0', 0, 0),
(2, 'Mobileverify', '手机验证码', '手机验证码', 0, 1, '{"account_sid":"","auth_token":"","app_id":"","template_id":"","expire_minute":"30"}', 'send_mobile_verify_code', 1, 'ThinkCMF', '1.0', 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `cmf_plugin_crplatform`
--

CREATE TABLE IF NOT EXISTS `cmf_plugin_crplatform` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `sms_cat` varchar(50) NOT NULL COMMENT '短信类型',
  `sms_content` varchar(255) NOT NULL COMMENT '短信内容',
  `add_time` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='短信内容模板' AUTO_INCREMENT=8 ;

--
-- 转存表中的数据 `cmf_plugin_crplatform`
--

INSERT INTO `cmf_plugin_crplatform` (`id`, `sms_cat`, `sms_content`, `add_time`) VALUES
(1, 'reg_sms', '恭喜您注册成功', '2017-02-22 06:17:15'),
(7, 'login_sms', '恭喜您登录成功', '2017-02-23 14:38:48');
...
(1, 1, '首页轮播', 'admin/20170222/58ad2358cb461.jpg', '', '', '', 1, 0),
(2, 1, '第二章幻灯片', 'admin/20170222/58ad27f396f0a.jpg', '', '', '', 1, 0);
...
(1, 'admin', '###f51d14e9797861a73332d1bd2f3274b1', 'admin', '2046151303@qq.com', '', NULL, 0, '2000-01-01', NULL, '127.0.0.1', '2017-02-23 10:57:06', '2017-02-22 01:26:07', '', 1, 0, 1, 0, '');
